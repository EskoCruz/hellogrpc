...
Client side metadata sending and receiving examples are available [here](../features/metadata/client/main.go).
...
Server side metadata sending and receiving examples are available [here](../features/metadata/server/main.go).
...
available [here](../features/metadata_interceptor/server/main.go).
